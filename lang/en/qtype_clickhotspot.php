...
$string['confirmimagetargetconversion'] = 'You are about to convert the above image target questions to the click hotspot question type.';
...
$string['dropzone'] = 'Hotspot zone {$a}';
$string['dropzoneheader'] = 'Hotspot zones';
$string['dropzones'] = 'Hotspot zones';
$string['dropzones_help'] = 'The hotspot zones are defined by typing co-ordinates. As you type, the preview above is immediately updated, so you can position things by trial and error.
...
$string['formerror_nobgimage'] = 'You need to select an image to use as the background for the click hotspot area.';
...
$string['imagetargetconverter'] = 'Convert image target questions to click hotspot';
...
$string['pluginname'] = 'Click Hotspot';
$string['pluginname_help'] = 'select a background image file, enter text labels for markers and define the hotspot zones on the background image to which they must be dragged.';
$string['pluginname_link'] = 'question/type/clickhotspot';
$string['pluginnameadding'] = 'Adding click hotspot';
$string['pluginnameediting'] = 'Editing click hotspot';
$string['pluginnamesummary'] = 'Markers are click onto a background image.';
$string['previewareaheader'] = 'Preview';
$string['previewareamessage'] = 'Select a background image file, enter text labels for markers and define the hotspot
 zones on the background image to which they must be dragged.';
...
$string['showmisplaced'] = 'Highlight hotspot zones which have not had the correct marker clicked on them';
$string['shuffleimages'] = 'Shuffle click items each time question is attempted';
$string['stateincorrectlyplaced'] = 'State which markers are incorrectly placed';
$string['summariseplace'] = '{$a->no}. {$a->text}';
$string['summariseplaceno'] = 'hotspot zone {$a}';
$string['ytop'] = 'Top';
