YUI.add('moodle-qtype_clickhotspot-dd', function(Y) {
    var CLICKHOTSPOTDDNAME = 'clickhotspot_dd';
    var CLICKHOTSPOT_DD = function() {
        CLICKHOTSPOT_DD.superclass.constructor.apply(this, arguments);
    };
    /**
     * This is the base class for the question rendering and question editing form code.
     */
    Y.extend(CLICKHOTSPOT_DD, Y.Base, {
        doc : null,
        polltimer : null,
    ...
    M.qtype_clickhotspot.dd_base_class = CLICKHOTSPOT_DD;

    var CLICKHOTSPOTQUESTIONNAME = 'clickhotspot_question';
    var CLICKHOTSPOT_QUESTION = function() {
        CLICKHOTSPOT_QUESTION.superclass.constructor.apply(this, arguments);
    };
    /**
    ...
    }, {NAME : CLICKHOTSPOTQUESTIONNAME, ATTRS : {dropzones:{value:[]}}});
    ...
    M.qtype_clickhotspot.init_question = function(config) {
        return new CLICKHOTSPOT_QUESTION(config);
    };
}, '@VERSION@', {
