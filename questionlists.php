...
class qtype_clickhotspot_category_list_item extends qtype_clickhotspot_list_item {
...
class qtype_clickhotspot_question_list_item extends qtype_clickhotspot_list_item {
...
class qtype_clickhotspot_context_list_item extends qtype_clickhotspot_list_item {
 ...
 **/
abstract class qtype_clickhotspot_list {
...
class qtype_clickhotspot_context_list extends qtype_clickhotspot_list {

    protected function new_list_item($stringidentifier, $link, $record) {
        return new qtype_clickhotspot_context_list_item($stringidentifier, $link, $record, $this);
    }
...
class qtype_clickhotspot_category_list extends qtype_clickhotspot_list {
    protected $contextlist;
    protected function new_list_item($stringidentifier, $link, $record) {
        return new qtype_clickhotspot_category_list_item($stringidentifier, $link, $record, $this, $this->contextlist);
    }
...
class qtype_clickhotspot_question_list extends qtype_clickhotspot_list {
    protected $categorylist;
    protected function new_list_item($stringidentifier, $link, $record) {
        return new qtype_clickhotspot_question_list_item($stringidentifier, $link, $record, $this, $this->categorylist);
    }
