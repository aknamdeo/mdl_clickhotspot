...
class qtype_clickhotspot_walkthrough_test extends qbehaviour_walkthrough_test_base {
    ...
    public function test_interactive_behaviour() {
        ...
        $dd = test_question_maker::make_question('clickhotspot');
        $dd->hints = array(
            new question_hint_clickhotspot(13, 'This is the first hint.',
                                                            FORMAT_HTML, false, false, false),
            new question_hint_clickhotspot(14, 'This is the second hint.',
    ...
    public function test_interactive_grading() {
        ...
        $dd = test_question_maker::make_question('clickhotspot');
        $dd->hints = array(
            new question_hint_clickhotspot(1, 'This is the first hint.',
                    FORMAT_MOODLE, true, true, false),
            new question_hint_clickhotspot(2, 'This is the second hint.',
                    FORMAT_MOODLE, true, true, false),
        );
        $dd->shufflechoices = false;
        $this->start_attempt_at_question($dd, 'interactive', 12);
    ...
    public function test_interactive_correct_no_submit() {
        ...
        $dd = test_question_maker::make_question('clickhotspot');
        $dd->hints = array(
            new question_hint_clickhotspot(23, 'This is the first hint.',
                    FORMAT_MOODLE, false, false, false),
            new question_hint_clickhotspot(24, 'This is the second hint.',
                    FORMAT_MOODLE, true, true, false),
        );
        $dd->shufflechoices = false;
