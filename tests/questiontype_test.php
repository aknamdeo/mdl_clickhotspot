 ...
 */
class qtype_clickhotspot_test extends basic_testcase {
    /** @var qtype_clickhotspot instance of the question type class to test. */
    protected $qtype;

    protected function setUp() {
        $this->qtype = question_bank::get_qtype('clickhotspot');;
    }
    ...
    public function test_name() {
        $this->assertEquals($this->qtype->name(), 'clickhotspot');
    }
