 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_clickhotspot_question extends qtype_ddtoimage_question_base {
    ...
    public function check_file_access($qa, $options, $component, $filearea, $args, $forcedownload) {
        ...
        if ($component == 'qtype_clickhotspot' && $validfilearea) {
    ...
    public function get_validation_error(array $response) {
        ...
        return get_string('pleasedragatleastonemarker', 'qtype_clickhotspot');
    }
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_clickhotspot_drag_item {
    public $text;
    public $no;
    public $infinite;
    public $noofdrags;
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_clickhotspot_drop_zone {
    public $group = 1;
    public $no;
    public $shape;
    public $coords;
    ...
    public function __construct($no, $shape, $coords) {
        $this->no = $no;
        $this->shape = qtype_clickhotspot_shape::create($shape, $coords);
        $this->coords = $coords;
    }

    public function summarise() {
        return get_string('summariseplaceno', 'qtype_clickhotspot', $this->no);
    }
