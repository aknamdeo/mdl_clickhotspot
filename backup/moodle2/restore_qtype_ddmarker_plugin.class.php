 ...
 * needed to restore one clickhotspot qtype plugin.
 *
 * @copyright  2011 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_qtype_clickhotspot_plugin extends restore_qtype_plugin {
    ...
    public function process_dds($data) {
        ...
        // we need to create its qtype_clickhotspot too.
        if ($questioncreated) {
            // Adjust some columns.
